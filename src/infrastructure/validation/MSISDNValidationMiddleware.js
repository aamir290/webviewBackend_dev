...
module.exports = function (req, res, next) {
  if(req && req.params && req.params.MSISDN){ //Parameter exists
    ...
    }else if(!validator.isLength(paramMSISDNuser, {min:3, max:15})) {//MSISDN between 3 & 15 detail for international number phone format https://www.cm.com/fr-fr/blog/comment-convertir-des-numeros-de-telephones-en-format-international/
